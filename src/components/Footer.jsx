...
// Make sure this path points to your logo file
...
const Footer = () => {
  return (
    <footer className="bg-gray-50 text-gray-600 pt-16 pb-8 border-t border-gray-200">
      {/* This container centers the content, but the footer's background is full-width */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <Link to="/">
              <img src={assets.logo} alt="TastyLane Logo" className="w-32 mb-4" />
            </Link>
            <p className="text-sm leading-relaxed pr-4">
              Connecting you with the best local restaurants. Fast delivery, great taste, and unforgettable flavors right to your doorstep.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/restaurants" className="hover:text-red-500 transition-colors">Restaurants</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                <span>✉️</span>
                <span>support@tastylane.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-red-500 transition-colors"><FacebookIcon /></a>
              <a href="#" className="text-gray-500 hover:text-red-500 transition-colors"><InstagramIcon /></a>
              <a href="#" className="text-gray-500 hover:text-red-500 transition-colors"><TwitterIcon /></a>
            </div>
          </div>
        </div>
        ...
        <p className="text-sm text-center text-gray-500">
          © {new Date().getFullYear()} TastyLane. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
